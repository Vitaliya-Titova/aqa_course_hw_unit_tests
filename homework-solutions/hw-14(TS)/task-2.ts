...
function customUnMap<T, U>(array: T[], callback: (element: T, index: number, array: T[]) => U): U[] {
  const result: U[] = [];
...
console.log(customUnMap([1, 2, 3, 4, 5], (element, index) => element * index));
console.log(customUnMap([1, '2', 3, 4, 5], (element) => +element));
